 ...
 $('#faq').click(function(){
    ...
    <div class="fixed top-0 bottom-0 right-0 left-0 z-50 flex justify-center items-center bg-black bg-opacity-40 font-paragraph" id='formFAQ'>
        <div class="hidden scale-0 opacity-0 transform  duration-300 transition-all xl:w-1/2 lg:w-7/12 md:w-2/3 sm:w-3/4 w-11/12 bg-gray-100 bg-opacity-0">
            <div class="bg-primary pt-2 px-6 rounded-t-2xl flex items-center justify-between text-secondary text-xl">
                <div class="flex font-heading font-bold w-11/12">
                    <div class="bg-gray-100 px-6 py-2 rounded-t-xl w-1/2 text-center cursor-pointer" id="tabSK">Syarat & Ketentuan</div>
                    <div class="px-6 py-2 rounded-t-xl w-1/2 text-center cursor-pointer" id="tabFAQ">FAQ</div>
                </div>
            ...
            <div class="bg-gray-100 h-96 overflow-y-auto py-3 px-6 text-primary rounded-b-2xl" id="syaratketentuan">
            ...
            <div class="bg-gray-100 h-96 overflow-y-auto py-3 px-6 text-primary rounded-b-2xl hidden" id="frequent">
