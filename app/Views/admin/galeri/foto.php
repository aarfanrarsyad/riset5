        ...
        <form id="form-input-upload" action="<?= base_url('/admin/foto_upload') ?>" method="post" enctype="multipart/form-data" class="flex flex-col text-sm">
          <div class="flex mt-5">
            <div class="flex justify-start items-center mb-2 w-full relative">
              ...
              <label for="pilihFile" title="Harus Diisi" class="pilihFile border border-primary text-sm text-secondary rounded-full w-24 py-1 text-center cursor-pointer hover:bg-secondaryhover transition-colors duration-300 text-sm mr-4 outline-none">Pilih File</label>
