                ...
                <div class="card card-light card-outline card-outline-tabs elevation-3">
                    ...
                    <div class="card-header mt-2 p-0 border-bottom-0 ">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active text-secondary" data-toggle="pill" href="#tab1" role="tab" aria-controls="tab1" aria-selected="false">Reset Attempts List &ensp;
                                    <span class="badge bg-indigo right" title="<?= count($reset_attempts) ?> Data"><i class="far fa-bell"></i>
                                        <?= count($reset_attempts) ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
