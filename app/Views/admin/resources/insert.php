                    ...
                    <div class="row">
                        <div class="col-md-12 text-sm">
                            <form action="" method="post">
                                ...
                                <br>
                                <div class="form-group row pl-4">
                                    <button type="submit" name="insert_resources" class="btn btn-sm text-white bg-secondaryhover hover:bg-opacity-75"><i class="fas fa-paper-plane"></i>&ensp;Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
