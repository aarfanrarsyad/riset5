                        ...
                        <div class="card-body">
                            ...
                            <form action="/admin/updateInstansi" method="post" class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control inputForm <?= ($validation->hasError('nama_instansi')) ? 'is-invalid' : ''; ?>" id="nama_instansi" name="nama_instansi" value="<?= $instansi->nama_instansi; ?>">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control inputForm <?= ($validation->hasError('alamat_instansi')) ? 'is-invalid' : ''; ?>" id="alamat_instansi" name="alamat_instansi" rows="2"><?= $instansi->alamat_instansi; ?></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control inputForm <?= ($validation->hasError('negara')) ? 'is-invalid' : ''; ?>" id="negara" name="negara" value="<?= $instansi->negara; ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control inputForm <?= ($validation->hasError('provinsi')) ? 'is-invalid' : ''; ?>" id="provinsi" name="provinsi" value="<?= $instansi->provinsi; ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control inputForm <?= ($validation->hasError('kota')) ? 'is-invalid' : ''; ?>" id="kota" name="kota" value="<?= $instansi->kota; ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control inputForm <?= ($validation->hasError('telp_instansi')) ? 'is-invalid' : ''; ?>" id="telp_instansi" name="telp_instansi" value="<?= $instansi->telp_instansi; ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control inputForm <?= ($validation->hasError('faks_instansi')) ? 'is-invalid' : ''; ?>" id="faks_instansi" name="faks_instansi" value="<?= $instansi->faks_instansi; ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="email" class="form-control inputForm <?= ($validation->hasError('email_instansi')) ? 'is-invalid' : ''; ?>" id="email_instansi" name="email_instansi" value="<?= $instansi->email_instansi; ?>">
                                    <div class="invalid-feedback">
