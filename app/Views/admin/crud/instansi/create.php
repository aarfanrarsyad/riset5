                        ...
                        <div class="card-body">
                            ...
                            <form action="/admin/CRUD_saveInstansi" method="post" class="row g-3 col-sm-10">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('nama_instansi')) ? 'is-invalid' : ''; ?>" id="nama_instansi" name="nama_instansi" value="<?= old('nama_instansi'); ?>">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control <?= ($validation->hasError('alamat_instansi')) ? 'is-invalid' : ''; ?>" id="alamat_instansi" name="alamat_instansi" rows="2" value="<?= old('alamat_instansi'); ?>"></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('negara')) ? 'is-invalid' : ''; ?>" id="negara" name="negara" value="<?= old('negara'); ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('provinsi')) ? 'is-invalid' : ''; ?>" id="provinsi" name="provinsi" value="<?= old('provinsi'); ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('telp_instansi')) ? 'is-invalid' : ''; ?>" id="telp_instansi" name="telp_instansi" value="<?= old('telp_instansi'); ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('faks_instansi')) ? 'is-invalid' : ''; ?>" id="faks_instansi" name="faks_instansi" value="<?= old('faks_instansi'); ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="email" class="form-control <?= ($validation->hasError('email_instansi')) ? 'is-invalid' : ''; ?>" id="email_instansi" name="email_instansi" value="<?= old('email_instansi'); ?>">
                                    <div class="invalid-feedback">
