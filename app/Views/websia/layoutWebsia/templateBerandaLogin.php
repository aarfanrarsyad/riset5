...
<html lang="en">
    ...
    <body class="flex min-h-screen flex-col overflow-x-hidden">
        ...
        <button onclick="topFunction()" id="onTopBtn" title="Kembali ke Atas"
            class="hidden fixed bottom-5 right-8 w-10 h-10 p-1 cursor-pointer rounded-full border-none focus:outline-none z-50 bg-secondary">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-white mx-auto" fill="currentColor"
        ...
        <!-- HEADER -->
        <div class="navbar w-full fixed z-30 bg-cover bg-no-repeat bg-left transition duration-700 ease-out"
            style="background-image: url(/img/components/bgHeader.png)" id="navbar">
            <header>
                <div class="flex flex-col">
                    <div class="flex items-center justify-between px-6 md:pt-3 pt-1 ">
                        <div class="">
                            <div class="flex">
                                <a href="<?= base_url(); ?>">
                                    <img src="/img/components/logo/logo_sia.png" class=" z-50 md:w-16 w-10"
                                        alt="logo SIA">
                                </a>
                            ...
                            <div class="font-paragraph hidden md:flex items-end justify-start pt-1">
                                <a href="<?= base_url(); ?>">
                                    <div
                                        class="nav-menu transition-colors duration-300 <?= ($active == 'beranda') ? 'activeMenu' : ''; ?>">
                                        BERANDA
                                    </div>
                                </a>
                                <a href="/user/profil">
                                    <div
                                        class="nav-menu transition-colors duration-300 <?= ($active == 'profil') ? 'activeMenu' : ''; ?>">
                                        PROFIL
                                    </div>
                                </a>
                                <div class="dropdown menuGaleri">
                                    <div
                                        class="nav-menu cursor-pointer transition-colors duration-300 <?= ($active == 'galeri') ? 'activeMenu' : ''; ?>">
                                        GALERI
                                    </div>
                                ...
                                <a href="/beranda/berita">
                                    <div
                                        class="nav-menu transition-colors duration-300 <?= ($active == 'berita') ? 'activeMenu' : ''; ?>">
                                        BERITA
                                    </div>
                                </a>
                                <a href="/developer">
                                ...
                                <a href="/admin">
                                    <div
                                        class="nav-menu transition-colors duration-300 <?= ($active == 'admin') ? 'activeMenu' : ''; ?>">
                                        ADMIN
                                    </div>
                                </a>
                                <?php endif; ?>
                                ...
                                <form action="/user/searchAndFilter" method="get">
                                    <div
                                        class="flex items-end text-sm relative text-white ml-1 p-1 bg-primaryLight transition-colors duration-300 md:w-32 lg:w-48 w-full">
                                        ...
                                        <input type="text" name="cari" placeholder="|  CARI" autocomplete="off"
                                            class="placeholder-white bg-transparent focus:outline-none ml-6 font-paragraph p-1"
                        ...
                        <div class="flex my-auto">
                            <a href="/auth/logout"
                                class="font-paragraph font-medium items-center hidden md:flex md:h-9 md:px-5 md:mt-3.5 md:-mb-14 md:shadow-sm md:text-base  md:text-white md:bg-secondary hover:bg-secondaryhover transition-colors duration-200 hover:rounded">
                                KELUAR
                            </a>
                            <div class="">
                                <button type="button"
                                    class="block text-white hover:text-gray-200 focus:text-gray-200 focus:outline-none md:hidden"
                                    id="hamburger">
                                    <svg class="w-8 fill-current" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="md:hidden">
                        <div class="flex flex-col hidden w-full border-t border-b border-white py-2 font-paragraph"
                            id="menu">
                            <a href="<?= base_url(); ?>">
                                <div
                                    class="nav-menu-relative px-2 py-2 <?= ($active == 'beranda') ? 'activeMenu' : ''; ?>">
                                    BERANDA
                                </div>
                            </a>
                            <a href="/user/profil">
                                <div
                                    class="nav-menu-relative px-2 py-2 <?= ($active == 'profil') ? 'activeMenu' : ''; ?>">
                                    PROFIL
                                </div>
                            </a>
                            <div class="flex flex-col">
                                <div class="nav-menu-relative flex px-2 py-2 <?= ($active == 'galeri') ? 'activeMenu' : ''; ?>"
                                    id="galeri">
                                    <div class="mx-auto">
                                        GALERI
                                        <svg class="inline w-4 h-4 my-auto ml-1" fill="none" id="downGaleri"
                                            stroke="currentColor" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 9l-7 7-7-7"></path>
                                        </svg>
                                        <svg class="inline w-4 h-4 my-auto ml-1 hidden" fill="currentColor"
                                            id="upGaleri" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                            ...
                            <a href="/Berita/berita">
                                <div
                                    class="nav-menu-relative px-2 py-2 <?= ($active == 'berita') ? 'activeMenu' : ''; ?>">
                                    BERITA
                                </div>
                            </a>
                            <a href="/developer">
                            ...
                            <form action="/user/searchAndFilter" method="get">
                                <div class="flex  justify-center text-sm relative text-white p-3 cari mt-1 px-2">
                                    ...
                                    <input type="text" name="cari" placeholder="    |  CARI" id="inputCari"
                                        class="placeholder-white bg-transparent ml-6 text-xs text-center w-2/3 outline-none "
                                        value="<?= isset($_GET['cari']) ? $_GET['cari'] : '' ?>">
                                </div>
                            </form>
                            <a href="/auth/logout">
                                <div
                                    class=" mt-1 px-2 py-2 w-11/12 mx-auto font-medium bg-secondary hover:bg-secondaryhover transition-colors duration-200 text-xs text-center text-white ">
                                    KELUAR
                                </div>
                            </a>
                        </div>
        ...
        <div class="bg-primary w-full pt-6 pb-3 lg:px-20 md:px-8 px-3">
            <div class="flex flex-col md:flex-row md:justify-around md:text-sm text-xs  items-center md:items-start">
                ...
                <div class="flex  gap-x-2 mx-auto md:mx-0 mb-2 md:mb-0">
                    <div class=" md:w-auto">
                        <a href="https://stis.ac.id/"><img class="lg:w-24 lg:h-24 w-20 h-20"
                                src="/img/components/logo/logo_stis.png" alt="logo STIS"></a>
                    </div>
                    <div class="text-white font-heading">
                        ...
                        <div class="flex gap-x-2 mt-2">
                            <a href="https://www.facebook.com/PolstatSTIS/"><img class="lg:h-6 h-4"
                                    src="/img/components/icon/facebook.png" alt="icon facebook"></a>
                            <a href="https://www.youtube.com/channel/UCwmpr4lmrApoGRpq4TcmsvA"><img class="lg:h-6 h-4"
                                    src="/img/components/icon/youtube.png" alt="icon youtube"></a>
                            <a href="https://twitter.com/stisjkt"><img class="lg:h-6 h-4"
                                    src="/img/components/icon/twitter.png" alt="icon twitter"></a>
                            <a href="https://www.instagram.com/polstatstis/"><img class="lg:h-6 h-4"
                                    src="/img/components/icon/instagram.png" alt="icon instagram"></a>
                        </div>
                    </div>
                </div>
                <!-- akhir footer stis -->
                ...
                <div class="md:mt-0 mx-auto md:mx-0 mb-2 md:mb-0">
                    <a href="https://haisstis.org/"><img class="lg:h-28 h-20 w-36 lg:w-auto md:-mt-4 lg:-mt-6"
                            src="/img/components/logo/logo_haisstis.png" alt="logo HAISSTIS"></a>
                ...
                <div
                    class="flex flex-col text-white text-center md:text-left font-heading mx-auto md:mx-5 mt-4 md:mt-0">
