...
<div class="flex flex-col-reverse md:grid md:grid-cols-4 lg:grid-cols-5 md:gap-4">
    <div class="md:col-span-2 lg:col-span-3">
        <div class="flex flex-col mb-10 mx-6 md:m-10 text-center md:text-left">
            ...
            <button class="unggahVideo focus:outline-none focus-within:lg:mr-24 p-1 rounded-3xl text-base lg:text-xl bg-secondary border-2 border-secondary text-white hover:bg-white hover:border-2 hover:border-secondary hover:text-secondary transition-colors duration-300 font-paragraph">UNGGAH KENANGANMU</button>
        </div>
    </div>
