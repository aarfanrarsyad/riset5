...
<div class="md:mt-8 mt-4 lg:px-20 md:px-8 px-3 text-sm">
        ...
        <div>
            <div class="flex items-center gap-x-2">
                <a href="/User/unggahBerita">
                    <div
                        class="bg-secondary hover:bg-secondaryhover md:py-1.5 md:px-3 py-1 px-2 outline-none text-white rounded-full cursor-pointer">
                        Unggah Berita
                    </div>
                </a>

                <svg class="w-6 cursor-pointer z-20 select-none" id="notif" width="42" height="42" viewBox="0 0 42 42"
                ...
                <div
                    ...
                    <div class="bg-gray-100 flex p-2 gap-x-2 mb-2">
                        ...
                        <div class="lg:w-1/4 md:w-1/5 w-1/3 lg:h-16 h-12"
                            style="background-image: url('<?= base_url('berita/berita_' . $notification['id'] . '/' . $notification['thumbnail']) ?>'); background-repeat: no-repeat;background-size:cover">
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
    ...
    <div class="mt-4 bg-primary md:p-6 p-3">
        ...
        <div class="md:grid md:grid-cols-3 md:gap-x-6 mt-4">
            <div class="md:col-span-2 md:h-full h-32 flex items-end p-2 sm:mb-6 mb-2 md:mb-0"
                style="background-image: url('<?= base_url('berita/berita_' . $newsPop[0]['id'] . '/' . $newsPop[0]['thumbnail']) ?>'); background-repeat: no-repeat;background-size:cover">
            ...
            <div class="md:grid md:grid-rows-2 md:gap-y-6">
                <div class="lg:h-48 h-32 flex items-end p-2 sm:mb-6 mb-2 md:mb-0"
                    style="background-image: url('<?= base_url('berita/berita_' . $newsPop[1]['id'] . '/' . $newsPop[1]['thumbnail']) ?>');background-repeat: no-repeat;background-size:cover">
                ...
                <div class="lg:h-48 h-32 flex items-end p-2"
                    style="background-image: url('<?= base_url('berita/berita_' . $newsPop[2]['id'] . '/' . $newsPop[2]['thumbnail']) ?>'); background-repeat: no-repeat;">
                    <a href="<?= base_url('/berita/news_view/' . $newsPop[2]['id']) ?>"
            ...
            <div>
                <div class="flex gap-x-2 items-center">
                    <div class="lg:w-1/4 w-1/3 lg:h-24 h-20 bg-gray-200"
                        style="background-image: url('<?= base_url('berita/berita_' . $dataset[$i]['id'] . '/' . $dataset[$i]['thumbnail']) ?>'); background-repeat: no-repeat;background-size:cover">
                    </div>
