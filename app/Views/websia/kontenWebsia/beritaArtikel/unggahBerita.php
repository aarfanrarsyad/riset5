...
<div class="md:mt-8 mt-4 lg:px-20 md:px-8 px-3 flex flex-col flex-1 text-sm">
    <div class="flex justify-between relative">
        ...
        <div class="transition-all duration-300 rounded-xl text-primary px-5 py-2 text-sm absolute -right-1 top-10 transform origin-top-right">
    ...
    <div class="flex flex-col flex-1 justify-center">
        <form id="formUnggahBerita" action="<?= base_url('websia/berandaBerita') ?>" method="post" class="2xl:mx-32 xl:mx-16 md:mx-8 sm:mx-4 mx-2 rounded-xl shadow-2xl py-6 xl:px-10 sm:px-6 px-3 md:my-10 my-6">
            ...
            <div class="flex">
                <label for="tanggalPublish" class="text-primary font-bold flex items-center mb-2 sm:text-sm text-xs mr-2" style="width: 14%;">Tanggal Publish*</label>
                <div class="flex xl:w-1/4 md:w-1/3 w-1/2">
                    <input type="date" title="Harus Diisi" class="inputForm" name="tanggalPublish" id="tanggalPublish">
                </div>
            </div>
