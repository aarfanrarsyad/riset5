    ...
    <div class="flex justify-between items-end">
        ...
        <div>
            <div class="flex items-center gap-x-2">
                ...
                <svg class="w-6 cursor-pointer z-20" onclick="notif(this)" id="notif1" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <div class="hidden lg:w-2/5 md:w-2/3 w-3/4 opacity-0 transition-all duration-300 rounded-xl text-primary py-2 text-sm absolute lg:right-18 -lg:right-2 md:right-6 right-1 lg:top-52 md:top-48 top-28 h-72 overflow-y-auto z-20">
    ...
    <div class="md:flex lg:flex justify-between">
        <div class="flex-grow">
            <div class="flex flex-col lg:mr-8 md:mr-4 sm:mr-8 lg:ml-0 md:ml-0 sm:ml-4">
                ...
                <div class="lg:h-72 h-60 mb-2 border border-gray-400">
                    <img src="<?= base_url('berita/berita_' . $dataset['id'] . '/' . $dataset['thumbnail']) ?>" alt="gambar berita" class="w-full h-full object-contain">
                </div>
