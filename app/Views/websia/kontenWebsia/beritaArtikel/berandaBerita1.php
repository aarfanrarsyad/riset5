...
<div class="md:mt-8 mt-4 lg:px-20 md:px-8 px-3 text-sm">
                    ...
                    <div class="bg-gray-100 flex p-2 gap-x-2">
                        <div>
                            ...
                            <div class="flex gap-x-2 items-center">
                                <img src="/img/icon/calendar.png" class="w-5 h-5" alt="icon kalender">
                ...
                <div class="hidden lg:w-2/5 md:w-2/3 w-3/4 opacity-0 transition-all duration-300 rounded-xl text-primary py-2 text-sm absolute lg:right-18 -lg:right-2 md:right-6 right-1 md:top-48 top-28">
                    ...
                    <div class="bg-gray-100 flex p-2 gap-x-2 mb-2">
                        <div class="lg:w-3/4 md:w-4/5 w-2/3">
                            ...
                            <div class="flex gap-x-2 items-center">
                                <img src="/img/icon/calendar.png" class="w-5 h-5" alt="ikon kalender">
    ...
    <div>
                ...
                <div class="flex gap-x-2 items-center">
                    ...
                    <div class="lg:w-3/4 w-2/3">
                        ...
                        <div class="flex gap-x-1 items-center">
                            <img src="/img/icon/clock.png" class="w-3 h-3" alt="tanggal">
                            <p class="text-xs text-primary">11 Januari 2021</p>
                            <img src="/img/icon/profile.png" class="w-3 h-3 ml-2" alt="author">
        ...
        <div class="flex gap-x-2 items-center justify-end mb-8">
            <a href="">
                <img src="/img/left-on.png" class="w-4 h-4 cursor-pointer" alt="Berita sebelumnya">
            </a>
            <a href="" class="text-secondary">1</a>
            <a href="" class="text-secondary">2</a>
            <a href="">
                <img src="/img/right-on.png" class="w-4 h-4 cursor-pointer" alt="Berita berikutnya">
            </a>
        </div>
    </div>
</div>
