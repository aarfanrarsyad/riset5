...
<div class="w-full bg-white mb-8 md:overflow-x-auto overflow-x-scroll rounded-3xl shadow-2xl" id="pagePrestasi">
    <!-- start tabel prestasi -->
    <table class="w-full sm:text-sm text-xs font-paragraph rounded-3xl shadow-2xl">
        <!-- start nama kolom tabel prestasi -->
        <thead class="formEdit">
            <tr>
                <th class="py-4 lg:px-3 px-2">No</th>
                <th class="lg:px-2 px-1">Nama Prestasi</th>
                <th class="lg:px-2 px-1">Tahun</th>
                <th class="lg:px-2 px-1">Aksi</th>
            </tr>
        </thead>
