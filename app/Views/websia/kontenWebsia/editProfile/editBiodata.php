                ...
                <div>
                    <div class="flex items-center mb-2">
                        ...
                        <div class="relative w-full">
                            ...
                            <div class="opacity-0 scale-0 transition-all xl:w-2/3 w-3/4 duration-200 rounded-xl text-primary text-justify px-5 py-1 md:text-sm text-xs absolute -left-5 md:top-9 top-8 transform origin-top-left">
                                <p>
