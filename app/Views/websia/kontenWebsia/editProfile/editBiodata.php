            ...
            <form action="/User/updateProfil" method="POST" class="font-paragraph text-primary lg:col-span-3" id="formEditBiodata">
                ...
                <div class="flex items-center gap-x-2 mb-2 relative">
                    ...
                    <div>
                        ...
                        <div class="opacity-0 scale-0 sm:w-1/2 w-2/3 rounded-xl text-primary text-justify md:px-5 px-2 py-1 text-sm absolute z-10 top-9 transform origin-top-left trnasition-all duration-150">
                            <div>
