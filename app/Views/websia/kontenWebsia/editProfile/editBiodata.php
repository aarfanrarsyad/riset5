                ...
                <hr class="border-gray-300 my-3">
                    ...
                    <div class="flex items-center gap-x-2 mb-2">
                        ...
                        <div>
                            ...
                            <div class="opacity-0 scale-0 transition-all md:w-1/3 w-1/2 duration-200 rounded-xl text-primary text-justify md:px-5 px-2 py-1 md:text-sm text-xs absolute">
                                <p>
