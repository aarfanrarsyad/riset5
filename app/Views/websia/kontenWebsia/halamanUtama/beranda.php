...
<div class="flex md:flex-row flex-col-reverse my-8 pt-0 lg:px-20 md:px-8 px-5">
    <div class="md:w-2/3 block md:px-2 md:py-8 pb-4">
        ...
        <p class="text-primary text-justify font-paragraph">
            ...
            STIS. Dengan sistem informasi database alumni ini juga diharapkan dapat mempermudah dalam mencari data alumni AIS/STIS/Politeknik Statistika STIS mulai dari
            angkatan 1 hingga angkatan terakhir yang baru lulus.
        </p>
...
<div class="w-full my-8 lg:px-20 md:px-8 px-5">
    ...
    <div class="flex flex-col items-center md:flex-row md:justify-around w-full text-center mt-4">
        <!-- Awal Jumlah Alumni AIS/STIS/Polstat STIS I -->
        <div class="mb-2 md:mb-0 py-6 px-6 bg-contain bg-no-repeat bg-center" style="background-image: url(/img/components/atribut_beranda_sia/bulat.png)">
