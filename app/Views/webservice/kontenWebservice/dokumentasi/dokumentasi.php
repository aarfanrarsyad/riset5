...
<div class="sm:ml-12 sm:mr-5 ml-8 mr-2 sm:mt-10 mt-7 transition-none overflow-hidden">
    <section>
        ...
        <div class="lg:mx-4 mx-3 mt-4 2xl:-mb-2 mb-10">
            ...
            <div class="flex ">
                <p class="text-justify md:mr-8 sm:mr-2 mr-0 xl:w-10/12 lg:w-9/12">API Sistem Informasi Alumni menyediakan akses terprogram untuk membaca data SIA. Pengguna dapat membaca tentang Detail User, Detail Alumni, dan List Detail Alumni. API Sistem Informasi Alumni mengidentifikasi pengguna dengan api-key. Pengguna bisa mendapatkan api-key dari situs Webservice Sistem Informasi Alumni. Tanggapan dari API tersedia dalam bentuk JSON.</p>
                <img src="/img/components/logo/logo_api.png" alt="Logo Api" class="xl:w-2/12 md:w-3/12 sm:w-4/12 sm:block hidden">
            </div>
        </div>
    </section>
